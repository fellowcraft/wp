...
a4      oscil3  (kModEnv+gklfo)*0.03,ifreq+gklfo,ifilter
a3      oscil3  kAmpEnv,(ifreq+a4)*.9999,ifilter
a2      oscil3  (kModEnv+gklfo)*0.02,ifreq+gklfo,ifilter
a1      oscil3  kAmpEnv,ifreq+a2,ifilter

outs    a1+a3 *  kpan, a1+a3 * (1 - kpan)

galeft    =         galeft  +  (a1+a3)*kpan     * irevSend
garight   =         garight +  (a1+a3)*(1-kpan) * irevSend
