...
a3   oscil3  kModEnv*0.1+gklfo,ifreq*iprnd,1
a4   oscil3  kAmpEnv,(ifreq+a3)*iprnd,1
a2   oscil3  kModEnv*0.2+gklfo,ifreq*iprnd,ifilter
a5   oscil3  kAmpEnv,ifreq+a2,ifilter
a1 = a5+a4
...
def RndEnvelope():
	...
	start = random.gauss(total/2,total/5)
	global duration
	duration = random.gammavariate(0.4,0.5)
	global at
	global attack
