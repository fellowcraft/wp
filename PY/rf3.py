...
alfo	oscil3  iamp*ipanEnd, 10, iprnd

kpan    linseg  ipanStart, idur, ipanEnd
kAmpEnv linseg  0, iat,  iamp*ipanStart, irel,  0
kModEnv linseg  0, iat2, iamp, irel2, 0

a2      oscil3  kModEnv+alfo,ifreq+a2,ifilter
...
def RndEnvelope():
	...
	global duration
	duration = max(random.gammavariate(45,.2),0.01)
	global at
	global attack
