...
iamp     		= ampdb(p4*0.76); amplitude in dB: 0-96
...
a3      oscil3 kAmpEnv*0.2   +kOsc,  ifreq/iprnd+a2, 1

a3b     oscil3 kOsc,  ifreq*iprnd+a2, 1

a3c     oscil3 kOsc*0.1,  ifreq*iprnd*4+a2, 1
