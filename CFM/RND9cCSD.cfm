...
kOsc    oscil3  iamp*0.01, .2, 1
	 
a2      oscil3  kModEnv/iprnd*0.1, ifreq, 1

a4      oscil3 kAmpEnv,      (ifreq+a2)   , int(ifilter)+1
a3      oscil3 kAmpEnv*0.01   +kOsc,  ifreq*iprnd+a2, int(ifilter)+1
;a3b     oscil3 kAmpEnv*0.1   +kOsc,  ifreq+ifreq*iprnd, int(ifilter)+1
;a3c     oscil3 kAmpEnv*0.05  +kOsc,  ifreq+ifreq*iprnd, int(ifilter)+1
